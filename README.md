...
## Python scripts info
Python script: run them directly in Rhino Python Editor or on Grasshopper Python component

<br>

### Mirror_Between and Mirror_Symmetrical
Use them with Rhino button or aliases (command macro)
<a href="https://ambrosinus.altervista.org/blog/calling-python-custom-scripts-with-buttons-and-aliases/" target="_blank">Extra info + description here</a>

<img src="https://ambrosinus.altervista.org/blog/wp-content/uploads/2023/10/Aliases_Python_script_v2-Time-0_00_0210.webp" width="50%" height="50%">
